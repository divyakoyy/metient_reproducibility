...
print("Weights", str(args.mig), str(args.comig), str(args.seed), str(args.gen))
...
for site in sites:
    ...
    for mig_type in mig_types:
        ...
        for seed in seeds:
            ...
            python_cmd = [f"bsub -J metient_sim_{site}_{mig_type}_{seed}_{run_name} -n 8 -W {time}:00 -R 'rusage[mem=6] span[hosts=1]' -o output_metient_sims_{run_name}.log -e error_metient_sims_{run_name}.log ./predict_single_simulated_tree.sh",
